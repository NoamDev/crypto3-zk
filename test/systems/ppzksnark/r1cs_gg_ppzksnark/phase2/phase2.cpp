#define BOOST_TEST_MODULE phase2_test
...
BOOST_AUTO_TEST_SUITE(phase2_test_suite)

BOOST_AUTO_TEST_CASE(phase2_compare_keypairs_without_delta_contribution_test) {
...
BOOST_AUTO_TEST_CASE(phase2_proof_verification_without_delta_contribution_test) {
